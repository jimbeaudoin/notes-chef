...
#   --filename FILE_NAME
sudo chef-server-ctl user-create stevedanno Steve Danno steved@getchef.com abc123 \
...
#   --filename FILE_NAME
sudo chef-server-ctl org-create chef Chef Software, Inc. --association_user stevedanno \
  --filename /path/to/file.key
```
...
# Generate an app (with a chef-repo folder inside)
